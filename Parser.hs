...
happyExpList = Happy_Data_Array.listArray (0,56) ([16176,1024,0,8,49152,62208,24579,126,0,0,0,512,0,0,38912,31,38912,128,52227,32783,505,16384,58880,7,0,0,62208,24579,126,24576,1,0,0,12304,0,38912,31,0,0,0
	])
...
action_25 (8) = happyShift action_27
